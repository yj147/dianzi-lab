        ...
        <div className="relative w-full md:w-5/12 bg-gradient-to-b from-lavender-100/50 via-white/20 to-mint-100/50 overflow-hidden p-6 sm:p-8 flex flex-col justify-center items-center">
          ...
          <div className="relative z-10 h-full w-full flex items-center justify-center">
            <div className="relative animate-float-slow">
              <div className="size-20 sm:size-24 rounded-full bg-coral-100 border-4 border-white shadow-lg overflow-hidden flex items-center justify-center">
                <span className="material-symbols-outlined text-5xl sm:text-6xl text-coral-400/80 mt-2" aria-hidden="true">
                  face_4
                </span>
              </div>
          ...
          <div className="mt-6 text-center md:hidden">
            <p className="mb-2 font-script text-xl text-coral-400 drop-shadow-sm">编织梦想</p>
            <p className="text-pretty text-sm font-medium text-slate-500">
              在奇迹工坊，每一个微小的想法
              <br />
              都值得被点亮。
