...
describe('ResultPanel Component', () => {
  ...
  it('renders success feedback with correct styling', () => {
    ...
    expect(
      container.querySelector('svg[data-lucide="CheckCircle2"]')
    ).toBeInTheDocument()
  })
  ...
  it('renders warning feedback with correct styling', () => {
    ...
    expect(screen.getByText(/市场竞争较为激烈/)).toBeInTheDocument()
    expect(
      container.querySelector('svg[data-lucide="AlertTriangle"]')
    ).toBeInTheDocument()
  })
  ...
  it('renders error feedback with correct styling', () => {
    ...
    expect(
      container.querySelector('svg[data-lucide="XCircle"]')
    ).toBeInTheDocument()
  })
  ...
  it('renders reset button when onReset is provided', () => {
    ...
    expect(
      screen.getByRole('button', { name: /重新评估/i })
    ).toBeInTheDocument()
  })
  ...
  it('does not render reset button when onReset is not provided', () => {
    ...
    expect(
      screen.queryByRole('button', { name: /重新评估/i })
