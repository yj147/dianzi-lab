...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed left-[50%] top-[50%] z-50 w-full max-w-lg translate-x-[-50%] translate-y-[-50%] rounded-lg bg-surface p-6 shadow-lg outline-none focus-visible:ring-2 focus-visible:ring-ring',
        className
      )}
      {...props}
    />
